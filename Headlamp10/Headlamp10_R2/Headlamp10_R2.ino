...
String FileName = "Headlamp9_R2";

// ---------------- nRF24L01 ---------------- //
#include <SPI.h>  
#include "RF24.h"
RF24 myRadio (7, 8);  // CE, CSN
const byte address_TR[6] = "10002";  // array of bits Transmitter to Reciever Lamp Left
...
const int x_bound_min = 28;                                    // minimum start position 
...
const int y_bound_max = 180;                      // maximum digital position verified
const int y_limit_max = 180;                      // maximum mechanical position before failure // 175
